...
class TestFib(unittest.TestCase):
    """Проверка корректности вычисления чисел Фибоначчи разными методами."""
...
class TestKnapsack(unittest.TestCase):
    """Тестирование реализации задачи о рюкзаке 0-1."""
...
class TestLCS(unittest.TestCase):
    """Проверка алгоритма нахождения наибольшей общей подпоследовательности."""
...
class TestLevenshtein(unittest.TestCase):
    """Тестирование вычисления редакционного расстояния."""
...
class TestCoinChange(unittest.TestCase):
    """Проверка корректности алгоритмов размена монет."""
...
class TestLIS(unittest.TestCase):
    """Тестирование поиска самой длинной возрастающей подпоследовательности."""
