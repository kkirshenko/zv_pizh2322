...
def demo_hash_tables():
    print("=== Пример использования HashTableChaining ===")
    ...
    print("=== Пример использования OpenAddressingHashTable ===")
...
def demo_performance_analysis():
    print("\n=== Замер производительности хеш-таблиц ===")
...
if __name__ == "__main__":
    # Запуск демонстрации и анализа производительности
    demo_hash_tables()
    demo_performance_analysis()
    # Генерация графиков на основе результатов тестирования
