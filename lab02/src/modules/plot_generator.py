...
def plot_insertion_comparison(sizes, list_times, linked_list_times):
    """График сопоставления вставки в начало списка и связного списка"""
...
def plot_asymptotic_comparison():
    ...
    # Теоретические оценки временной сложности
    n = list(range(1, 1001, 10))
    
    # O(1) против O(n) для вставки
    o1 = [1] * len(n)
    on = n
    ...
    # O(1) против O(n) для удаления из начала
