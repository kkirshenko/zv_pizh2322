...
class TestSmallHeap(unittest.TestCase):
    """Тестирование min-кучи (SmallHeap)."""
...
class TestLargeHeap(unittest.TestCase):
    """Тестирование max-кучи (LargeHeap)."""
...
class TestHeapsort(unittest.TestCase):
    """Проверка корректности реализации пирамидальной сортировки."""
...
class TestTaskQueue(unittest.TestCase):
    """Тестирование приоритетной очереди на основе кучи."""
